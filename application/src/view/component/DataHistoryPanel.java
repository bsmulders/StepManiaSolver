...
public class DataHistoryPanel extends JPanel {

	private static final long serialVersionUID = 7014541533055392738L;

	private Model model;

	public DataHistoryPanel(Model model, int width, int height) {
		setModel(model);
	...
	protected void paintComponent(Graphics graphics) {
		...
		ArrayList<DataPoint> copy = new ArrayList<DataPoint>(getModel().getDataHistory());
		...
		graphics2D.drawString("Data history", 10, 20);
